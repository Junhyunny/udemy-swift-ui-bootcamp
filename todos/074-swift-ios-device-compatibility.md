...
**Swift Evolution이 특히 유용하다.** "이 문법은 왜 이렇게 됐나"를 알고 싶을 때 답이 있다. 이 저장소의 문서에서도 [SE-0086 (NS 접두사 제거)](./116-ns-prefix-foundation-classes.md)와 [SE-0307 (CGFloat↔Double)](./061-coregraphics-types-and-cgfloat.md)을 근거로 인용했다.
