...
딥링크의 용도와 Info.plist 설정 항목은 [별도 문서](./085-deep-link-and-url-scheme.md)에 있다. 이 문서는 **iOS가 어떻게 앱을 찾아내는가**와 **같은 스킴이 겹치면 어떻게 되는가**를 다룬다.
...
- 받은 URL을 반드시 검증한다 ([보안 경고](./085-deep-link-and-url-scheme.md) 참조)
