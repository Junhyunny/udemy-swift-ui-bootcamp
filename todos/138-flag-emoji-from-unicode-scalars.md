...
[NS 접두사 문서](./116-ns-prefix-foundation-classes.md)에서 다룬 `utf16` 같은 다른 뷰도 있는데, 여기서는 코드 포인트 단위인 `unicodeScalars`가 맞다.
...
[클로저 축약 문서](./007-closure-shorthand-argument-names.md)에서 예로 든 것과 같은 연산자다.
