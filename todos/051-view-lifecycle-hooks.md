...
UIKit의 `UIViewController` 생명주기와 SwiftUI의 `.task`, `.onAppear`, `.onDisappear`를 큰 구조에서 비교하려면 [SwiftUI와 UIKit 아키텍처 학습 노트](./088-swiftui-and-uikit-architecture.md)를 함께 본다.
