...
`URL`과 `URLComponents`는 모두 `struct`, 즉 **값 타입**이다. [struct와 class](./019-struct-vs-class.md)에서 다룬 성질이 적용된다.
...
chapter-61에서도 이 원칙이 나왔다. [딥링크 문서](./085-deep-link-and-url-scheme.md)에서 인용한 Apple의 권고다.
