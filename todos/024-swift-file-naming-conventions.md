...
`extension`의 적용 범위와 파일 관리는 [별도 문서](./014-extension-keyword.md)에 정리했다. 이 문서는 **파일 이름 규칙**에 집중한다.
...
Swift extension은 이름이 없다. [extension 문서](./014-extension-keyword.md)에서 인용한 대로다.
